...
typedef enum {
    ...
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_PRODUCT_DONE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_PRODUCT_COMPLETE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_ICON_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_PACKAGE_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_PROPERTY_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_DIRECTORY_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_DIRECTORY_GENERATE_COMPONENT,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_DIRECTORY_GENERATE_DIRECTORY,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_DIRECTORY_DONE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_DIRECTORY_COMPLETE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_COMPONENT_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_COMPONENT_GENERATE_REFERENCE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_COMPONENT_COMPLETE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_FILE_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_FILE_GENERATE_FILE_SHORTCUT,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_FILE_DONE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_FILE_COMPLETE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_FILE_SHORTCUT_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_UNINSTALL_SHORTCUT_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_CREATE_FOLDER_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_REMOVE_FOLDER_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_ENVIRONMENT_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_REGISTRY_KEY_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_REGISTRY_KEY_COMPLETE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_REGISTRY_VALUE_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_FEATURE_GENERATE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_FEATURE_GENERATE_FEATURE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_FEATURE_GENERATE_COMPONENT,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_FEATURE_DONE,
    ADM_SIM_INDEX_EVENT_MATRIX_INSTALLER_FEATURE_COMPLETE
